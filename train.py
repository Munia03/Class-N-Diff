...
def main(args):
    ...
    logger.info(f"Training DiT model for label conditioning instead of text")
    ...
    if args.resume_from_checkpoint:
        ...
        state_dict = find_model(args.resume_from_checkpoint)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--test-no", type=int, required=True)
